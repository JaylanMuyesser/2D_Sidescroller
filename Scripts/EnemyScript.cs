...
public class EnemyScript : MonoBehaviour
{
    ...
    [SerializeField]
    private float enemyJumpSpeed = 10; // variable float declared for enemyJumpSpeed
    /*
    [SerializeField]
    ...
    */
    ...
    void Start()
    {
        ...
        enemyRb = GetComponent<Rigidbody2D>(); // making sure the variable gets the RigidBody2D component on start
